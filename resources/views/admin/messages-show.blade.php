...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <a href="{{ route('admin.messages.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> Back</a>
</div>
...
<div class="table-container" style="max-width: 820px;">
  ...
  <form method="POST" action="{{ route('admin.messages.reply', $user) }}">
    @csrf
    <div class="mb-2">
